...
const InsightModal = ({ isOpen, onClose, loading, onGenerateInsights, aiResponse }) => {
    return (
        <Modal isOpen={isOpen} onClose={onClose} title="Generate Insights">
            <div className="space-y-6">
                <p className="text-sm text-blue-700 leading-relaxed bg-blue-50 p-4 rounded-xl border border-blue-200">
                    The system will perform an in-depth analysis of the text and generate relevant insights and conclusions.
                </p>
                ...
                {aiResponse && (
                    <div className="border-t-2 border-blue-200 pt-6">
                        <h4 className="text-sm font-medium text-blue-900 mb-3">Insights and Conclusions</h4>
