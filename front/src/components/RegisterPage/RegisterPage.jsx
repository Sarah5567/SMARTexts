...
export default function Signup() {
    ...
    return (
        <div className="w-screen h-screen bg-gradient-to-tl from-indigo-50 via-white to-purple-50 flex items-center justify-center overflow-hidden relative pt-32">
            {/* Decorative elements */}
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-gray-100 p-12 w-full max-w-md mx-auto relative z-10">
                {/* Header with icon */}
                <div className="text-center mb-8">
                    ...
                    <p className="text-gray-500 text-sm">Join us to manage your documents</p>
                </div>
